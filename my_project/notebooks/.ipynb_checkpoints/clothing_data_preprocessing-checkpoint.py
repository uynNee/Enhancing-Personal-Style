...
# %%
sparse_matrix_products = df[['gender', 'masterCategory', 'subCategory', 'articleType', 'baseColour', 'season', 'usage', 'productDisplayName', 'productDescription']]
df1 = df[['gender', 'masterCategory', 'subCategory', 'articleType', 'baseColour', 'season', 'usage', 'productDisplayName', 'productDescription']]
...
with open('clothing_knn.pkl', 'wb') as f:
    pickle.dump((model, df1.columns), f)

# %%
# load the model from disk
with open('clothing_knn.pkl', 'rb') as f:
    loaded_model, train_columns = pickle.load(f)
