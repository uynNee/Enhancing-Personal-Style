...
def collaborative_filtering(user_likes_df):
    ...
    # Check if the user_id exists in the DataFrame's columns
    if user_id in user_similarity_df.columns:
        ...
        # Handle the case where the user_id does not exist in the DataFrame
        # For example, return an empty list or a default set of recommendations
        recommendations = []
